...
func (in *KubeadmConfigSpec) DeepCopyInto(out *KubeadmConfigSpec) {
	*out = *in
	...
	if in.AdditionalPreCommands != nil {
		in, out := &in.AdditionalPreCommands, &out.AdditionalPreCommands
		*out = make([]string, len(*in))
		copy(*out, *in)
	}
	if in.AdditionalPostCommands != nil {
		in, out := &in.AdditionalPostCommands, &out.AdditionalPostCommands
		*out = make([]string, len(*in))
		copy(*out, *in)
	}
}
